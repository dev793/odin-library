...
Did a simple refactor to create a Book class instead of using plain constructors. I probably should have made the fields private and used getters/setters, but I couldn't be bothered doing a larger refactor.